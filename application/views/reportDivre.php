  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
       ...
       $resultSumatera = mysqli_query($con,"SELECT DISTINCT KLASIFIKASI_STATUS_SMILE as 'STATUS SMILE', COUNT(KLASIFIKASI_STATUS_SMILE)-1 AS JUMLAH FROM tabel_lme_main WHERE DIVRE = 'R1 SUMATERA' GROUP BY KLASIFIKASI_STATUS_SMILE ORDER BY KLASIFIKASI_STATUS_SMILE ASC");
